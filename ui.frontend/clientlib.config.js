module.exports = {
	...
	clientLibRoot: './../ui.apps/src/main/content/jcr_root/apps/premember/clientlibs',

	libs: [
		{
			name: 'clientlib-dependencies',
			allowProxy: true,
			categories: ['premember.css.dependencies'],
		...
		},
		{
			name: 'clientlib-site',
			allowProxy: true,
			categories: ['premember.css.site'],
			dependencies: ['premember.css.dependencies'],
			serializationFormat: 'xml',
			cssProcessor: ['default:none', 'min:none'],
			jsProcessor: ['default:none', 'min:none'],
			assets: {
